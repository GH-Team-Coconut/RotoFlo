...
function geometricFilter(keypoints, canvasRef) {
  ...
  drawLineFromTo(canvasRef, gkp1, gkp4, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp1, gkp5, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp1, gkp6, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp1, gkp7, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp2, gkp12, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp3, gkp5, '7ea09b', 3);
  drawLineFromTo(canvasRef, gkp3, gkp7, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp5, gkp7, '7ea09b', 3);
  drawLineFromTo(canvasRef, gkp4, gkp5, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp4, gkp9, '7ea09b', 3);
  drawLineFromTo(canvasRef, gkp6, gkp7, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp6, gkp12, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp7, gkp10, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp7, gkp11, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp7, gkp12, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp7, gkp13, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp7, gkp14, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp8, gkp10, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp9, gkp10, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp10, gkp13, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp10, gkp15, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp11, gkp14, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp11, gkp13, '#7ea09b', 3);
  drawLineFromTo(canvasRef, gkp11, gkp15, '#db4855', 3);
  drawLineFromTo(canvasRef, gkp12, gkp14, '#7ea09b', 3);
